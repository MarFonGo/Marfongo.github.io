        ...
        <div  className="container-fluid" style={{padding: "20px"}}> 
            <div className="row" style={{display: "flex"}}>
                ...
                <div className="col-lg-6 col-md-12" style={{margin: "auto", display: "flex" , padding: "0px", justifyContent: "center"}}>
                    <video  width="90%" height="500px" src="IU.mp4" style={{objectFit: "cover",  display: "flex", borderRadius: "20px", border: "none"}} controls/>
                </div>
                <div className="col-lg-6 col-md-12" style={{padding: "20px", display: "block", overflow: "hidden", wordWrap: "break-word"}}>
                    <div className="card card-style" style={{backgroundImage: "url(images/secreto_de_medianoche.png)", backgroundRepeat: 'round', minHeight:'500px'}}>
                        <div className="card-block">
                            ...
                            <h2 style={{fontSize: "28px", padding: "20px", color: "rgba(240, 248, 255, 0.664)"}}> ¡Despierta tus sentidos con nuestra nueva fragancia! Presentamos nuestro exclusivo perfume, una combinación cautivadora 
